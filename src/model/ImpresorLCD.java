...
public class ImpresorLCD {
	...
	static final char POSICION_X = 'X';
	static final char POSICION_Y = 'Y';
	 ...
	 *            Caracter Segmento
	 */
	private void adicionarLinea(char[][] matriz, int[] punto, char posFija, int size, char caracter) {
	 ...
	 *            Espacio Entre digitos
	 */
	private void procesar(String comando, int espacioDig) {
	...
	public String refactorLCD(String comando) {
		...
		for (int i = 0; i < this.totalFilas; i++) {
			for (int j = 0; j < this.totalColum - 1; j++)
				constructorDeCadena.append(this.matrizImpr[i][j]);
